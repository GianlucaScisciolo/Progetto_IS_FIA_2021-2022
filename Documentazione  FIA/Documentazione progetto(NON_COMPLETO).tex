...
\begin{document}
  ...
  \section{Progettazione dell'algoritmo genetico}
    \label{progettazioneDellAlgoritmoGenetico}
    
    % Sezione 2.1
    \subsection{Spazio degli stati}
      \label{spazioDegliStati}
      ...
      Abbiamo quindi un vettore (Vettore 1) di N percorsi formativi in cui abbiamo l'id presente nel database:\\
      \begin{figure}[h!]
        \centering
        \caption{Vettore 1}
