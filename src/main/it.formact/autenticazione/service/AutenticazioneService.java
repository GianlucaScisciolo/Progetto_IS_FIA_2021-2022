...
public class AutenticazioneService implements Service{
	StudenteDao sDao;
	FormatoreDao fDao;
	Action loginPage = new Action("/formAct_FIA/view/autenticazione/Login.jsp", true, true);
	Action homePage = new Action("/formAct_FIA/view/index/index.jsp", true , true ); // redirect funziona a dovere, forward NO
