...
public class PercorsoFormativoService implements Service{
	...
	String orario; 
	Date currentDate;
	Action errorPage = new Action("/formAct_FIA/view/percorsoformativo/Iscrizione.jsp", true, true);
	//sendRedirect
	Action homePage = new Action("/formAct_FIA/view/index/index.jsp", true, true);
	Action resultRicercaPage = new Action("/formAct_FIA/view/percorsoformativo/RicercaPercorsoFormativo.jsp",true,true);
	Action viewPercorsiFormativiPage = new Action("/formAct_FIA/view/percorsoformativo/VisualizzaPercorsiFormativi.jsp", true, true);
