...
%>
        ...
        <div class="logo">
          <img src="/formAct_FIA/view/immagini/logo.png" alt="Logo" style="width:60%;">
        </div>
...
%>
        ...
        <div class="text-center fs-6"> 
          <a class="button" class="btn" href="/formAct_FIA/view/registrazione/RegistrazioneUtente.jsp?tipoIscrizione=0">Iscriviti</a>
        </div>
<%
      }
      else {
...
%>
    ...
    <script src="/formAct_FIA/view/js/validazioniForm/Autenticazione.js" type="text/javascript"></script>
