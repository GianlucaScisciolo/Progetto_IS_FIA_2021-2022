...
%>
        <div class="text-center mt-4 name">
         ...
         <a href="/formAct_FIA/view/autenticazione/Login.jsp" class="btn">Login</a> <br> <br>
        </div>
<%
      }
...
%>
          ...
          <img src="/formAct_FIA/view/immagini/avatar-login.png" alt="immagineProfilo" style="width:20%; display: block; margin:0 auto;">
        </div>
...
%>
        ...
        <div class="p-3 mt-3">
          <div class="row justify-content-md-center">
            ...
            <div class="col lg">
   				<a href="/formAct_FIA/view/autenticazione/ModificaProfilo.jsp" class="btn">Modifica profilo</a> <br> <br>
              		
             	<a href="/formAct_FIA/view/autenticazione/ModificaPassword.jsp" class="btn">Modifica password</a> <br> <br>
...
%>
			<div class="col lg">
				...
				<a href="/formAct_FIA/view/autenticazione/ModificaInteressi.jsp" class="btn">Modifica interessi</a> <br> <br>
              	<a href="/formAct_FIA/view/autenticazione/DisiscrizionePiattaforma.jsp" class="btn">Disiscriviti da FormAct</a> <br> <br> 	
...
%>
			<div class="col lg">
              	<a href="/formAct_FIA/view/gestionepf/CreaPercorsoFormativo.jsp" class="btn">Crea un percorso formativo</a> <br> <br> 
